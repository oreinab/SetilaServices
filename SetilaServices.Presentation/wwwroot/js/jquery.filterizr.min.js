    ...
    (r.prototype = {
        ...
        (i.fn.filterizr.prototype = {
            ...
            search: function (t) {
                ...
                else if (i._isSearchActivated()) for (n = 0; n < i._activeArray.length; n++) i._activeArray[n]._filterOut();
            ...
            _makeSubarrays: function () {
                ...
                for (r = 0; r < t._mainArray.length; r++)
                    if ("object" == typeof t._mainArray[r]._category) for (var e = t._mainArray[r]._category.length, n = 0; e > n; n++) i[t._mainArray[r]._category[n] - 1].push(t._mainArray[r]);
            ...
            _calcItemPositions: function () {
                ...
                if ("horizontal" === t.options.layout) for (a = 1, c = 1; c <= e.length; c++) (s = e[c - 1].outerWidth()), (l = e[c - 1].outerHeight()), _.push({ left: f, top: u }), (f += s), l > n && (n = l);
                    ...
                    for (c = 1; c <= e.length; c++) {
                        if ((_.push({ left: f, top: u }), c % o === 0 && a++, (f += s), (u = 0), a > 0)) for (g = a; g > 0; ) (u += e[c - o * g].outerHeight()), g--;
                        c % o === 0 && (f = 0);
                    }
                    for (c = 0; o > c; c++) {
